...
class MTPairs:
    def __init__(self,Input,Output,No_ofitem,No_ofhits,umbckey):
        self.Input=Input
        self.Output=Output
        self.No_ofitem=No_ofitem
        self.No_ofhits=No_ofhits
        self.fieldnames=[]
        self.umbckey=umbckey
...
if __name__ == '__main__':
    topic="gun-control"
    inputdir="/Users/amita/git/summary_repo/Summary/src"
    Input= inputdir + "/paraphrase/para_data/gun-control/cluster/TFIdf/Phase1/Pairs_Cos_Cluster_70_AVG_Noun_Verb_Ad"
    Output=inputdir +"/mechanicalTurk_pkg/" + topic + "/MTdata_cluster/Phase1/MT_PairsLabels"
    No_ofitem=5 
    No_ofhits=476
    umbckey="UMBC"
    MTPairsobj=MTPairs(Input,Output,No_ofitem, No_ofhits,umbckey)
    Execute(MTPairsobj)
