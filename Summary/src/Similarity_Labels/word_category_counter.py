...
try:
    liwc_2007_dic_filename = './LIWC2007.dic'
    _dictionary_filename = liwc_2007_dic_filename
except:
    sys.stderr.writelines(["Failed to FIND dictionary file\n"])
    raise
