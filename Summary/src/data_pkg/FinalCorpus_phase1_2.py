...
def Formatsummary(infile,outfile):
...
def execute(infile_1,infile_2,infile_1_2,outfile_1,outfile_2,outfile_1_2):  
    Formatsummary(infile_1,outfile_1) 
    Formatsummary(infile_2,outfile_2) 
    Formatsummary(infile_1_2,outfile_1_2) 
...
if __name__ == '__main__':
    ...
    execute(infile_1,infile_2,infile_1_2,outfile_1,outfile_2,outfile_1_2) 
